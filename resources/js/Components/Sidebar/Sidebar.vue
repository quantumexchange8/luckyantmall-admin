...
<template>
    ...
    <aside
        ...
        "
        :class="[
            'fixed inset-y-0 z-20 bg-white dark:bg-surface-950 flex flex-col border-r border-transparent dark:border-gray-700 shadow-[0_4px_16px_rgba(156,182,221,0.4)] dark:shadow-none',
            {
