...
<template>
    <div class="w-full py-5 px-4 md:p-5 flex flex-col items-center gap-5 self-stretch rounded-2xl border border-gray-200 bg-white shadow-table">
...
<!--                        </div>-->
                    ...
                    <div class="p-4 flex flex-col items-center gap-2 self-stretch">
                        ...
                        <div class="min-w-[240px] pb-2 grid grid-cols-2 gap-2 self-stretch border-b border-solid border-gray-200">
                            <div class="w-full flex flex-col items-start gap-1">
                                <span class="text-gray-500 text-xs">{{ $t('public.total_deposit') }}:</span>
                                <span class="text-gray-950 text-xs font-medium">$ {{ formatAmount(10000) }}</span>
                            </div>
                            <div class="w-full flex flex-col items-start gap-1">
                                <span class="text-gray-500 text-xs">{{ $t('public.total_withdrawal') }}:</span>
                                <span class="text-gray-950 text-xs font-medium">$ {{ formatAmount(10000) }}</span>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-2 self-stretch">
                            <div class="w-full flex items-center gap-1">
                                <span class="text-gray-500 text-xs">{{ $t('public.deposit') }}:</span>
                                <span class="text-gray-950 text-xs font-medium">$ {{ formatAmount(10000) }}</span>
                            </div>
                            <div class="w-full flex items-center gap-1">
                                <span class="text-gray-500 text-xs">{{ $t('public.withdrawal') }}:</span>
                                <span class="text-gray-950 text-xs font-medium">$ {{ formatAmount(10000) }}</span>
                            </div>
                            <div class="w-full flex items-center gap-1">
                                <span class="text-gray-500 text-xs">{{ $t('public.active_fund') }}:</span>
                                <span class="text-gray-950 text-xs font-medium">$ {{ formatAmount(10000) }}</span>
                            </div>
                            <div class="w-full flex items-center gap-1">
