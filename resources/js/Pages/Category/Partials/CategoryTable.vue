...
import ToggleCategoryStatus from "@/Pages/Category/Partials/ToggleCategoryStatus.vue";
            ...
            >
                ...
                >
                    ...
                    <template v-if="categories.length">
                        ...
                        >
                            <template #header>
                                <span class="hidden md:block">{{ $t('public.item') }}</span>
                            </template>
                            <template #body="slotProps">
                                {{ slotProps.data.item.name[locale] }}
                            </template>
                        </Column>
                        <Column
                            field="categories_count"
                        ...
                        >
                            <template #header>
                                <span class="hidden md:block">{{ $t('public.products') }}</span>
                            </template>
                            <template #body="slotProps">
                                <span class="lowercase">{{ slotProps.data.products_count > 0 ?  `${slotProps.data.products_count} ${$t('public.products')}` : '-' }}</span>
                            </template>
                        </Column>
                        <Column
                            field="status"
