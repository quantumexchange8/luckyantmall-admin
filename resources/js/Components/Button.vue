...
const variantClasses = (variant) => ({
    ...
    'bg-gray-100 dark:bg-gray-950 hover:bg-gray-200 dark:hover:bg-gray-900 border border-gray-100 hover:border-gray-200 dark:border-gray-700 dark:hover:border-gray-700 focus:ring-gray-100 dark:ring-gray-700 text-gray-500 dark:text-gray-300 disabled:border-gray-100 disabled:bg-gray-100 dark:disabled:border-gray-800 dark:disabled:bg-gray-800': variant === 'gray-tonal',
    'bg-transparent hover:bg-gray-50 dark:hover:bg-gray-950 border border-gray-300 hover:border-gray-400 dark:border-surface-700 dark:hover:border-gray-500 focus:ring-gray-300 dark:ring-gray-400 text-gray-950 dark:text-gray-300 dark:hover:text-white shadow-input disabled:bg-gray-100 dark:disabled:bg-gray-800 disabled:border-gray-200 dark:disabled:border-gray-800': variant === 'gray-outlined',
